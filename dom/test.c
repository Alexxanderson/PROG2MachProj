...
int deleteEntry(int nPkCtr) // Delete Entry
{
    // bug, regardless of entered index, the entry that will be deleted will be the most recent entry
    ...
    else
    {
        ...
        do
        {
            ...
            displayEntry(i-1); // display the entry for correction to the user
            printf("\n");
